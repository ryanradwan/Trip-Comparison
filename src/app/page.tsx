      ...
      <section style={{ marginBottom: 56 }}>
        ...
        >
          {[
            ...
            { value: "48", label: "Destinations covered" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 40 }}>
          {[
            ...
            { icon: "📊", title: "Expert City Data", desc: "48 destinations with scores across 18 categories, updated monthly with real travel insights." },
