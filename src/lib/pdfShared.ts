      ...
      el(View, { style: styles.pageContent },
        ...
        el(View, { style: { ...styles.tableHeader, alignItems: "center" as const } },
          ...
          el(View, { style: { flex: 1, marginHorizontal: 4, alignItems: "center" as const } },
            el(Text, { style: { color: "#FFFFFF", fontSize: 8.5, fontFamily: "Helvetica-Bold" } }, sanitize(result.city1.city))
          ),
          el(View, { style: { flex: 1, marginHorizontal: 4, alignItems: "center" as const } },
            el(Text, { style: { color: "#FFFFFF", fontSize: 8.5, fontFamily: "Helvetica-Bold" } }, sanitize(result.city2.city))
          ),
